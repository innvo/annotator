...
var Editor = exports.Editor = Widget.extend({
        ...
        if (this.options.defaultFields) {
             ...
             this.addField({
                ...
                load: function (field, annotation) {
                    ...
                    annotation.text = $(field).find('select').on('change', function(){
                        //alert($(this).val());
                        $('.annotator-item textarea').val($(this).val());
                    });
    ...
    addField: function (options) {
        ...
        if (field.type === 'textarea') {
            ...
            input = $('<select style="color: #1f811f;" class="form-control"><option style="color: #1f811f;" value="" disabled selected> -- Select your option -- </option><option style="color: #880000;">Question</option><option style="color: #2A00FF;">Entity</option><option style="color: #0a0a0a;">Others</option></select>');
        }
